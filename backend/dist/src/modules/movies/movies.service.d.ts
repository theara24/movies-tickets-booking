...
export declare class MoviesService {
    ...
    findAll(query: MovieQueryDto, page?: number, limit?: number): Promise<{
        data: ({
            genres: ({
                genre: {
                    id: string;
    ...
    getNowShowing(page?: number, limit?: number): Promise<{
        data: ({
            genres: ({
                genre: {
                    id: string;
    ...
    getComingSoon(page?: number, limit?: number): Promise<{
        data: ({
            genres: ({
                genre: {
                    id: string;

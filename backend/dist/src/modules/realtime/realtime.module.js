...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [seat_lock_gateway_1.SeatLockGateway, seat_lock_service_1.SeatLockService],
        exports: [seat_lock_gateway_1.SeatLockGateway, seat_lock_service_1.SeatLockService],
    })
], RealtimeModule);
